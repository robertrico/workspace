...
public class Definitions extends Dictionary{
    ...
    public void addDef(Scanner input){
        FileWriter out = new FileWriter(filename+".ref",true);
        Scanner fileIn = new Scanner(new File(filename+".ref"));
        System.out.println("Enter a new word to be defined.");
        out.write(input.nextLine());
        System.out.println("Enter a the definition for the word.");
        out.write(input.nextLine());
        out.close();
        ;
